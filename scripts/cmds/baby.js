...
const amiTomakeValobashi = ["ᴀᴍᴀʀ ꜱᴏɴᴀʀ ʙᴀɴɢʟᴀ ,ᴛᴀʀᴘᴏʀᴇ ʟᴀɪɴ ᴋɪ ?", "Yes 😀, I am here", "ᴇᴋᴛᴀ ɢғ ᴋʜᴜɴᴊᴇ ᴅᴇᴏ ꜱᴏᴍʀᴀᴛ ᴋ🥺🥺", "ᴠᴀʟᴏ ᴋɪ ʜᴏɪʙᴀ ɴᴀ?", "ᴛᴜᴍɪ ᴄʜᴀɴᴅ ɴᴀ, ᴛᴜᴍɪ ᴄʜᴀɴᴅᴇʀ ʀᴏꜱʜɴɪ ✨🥺", "ʜᴇʏ ᴍɪss ʀᴜ ʟᴏsᴛ ɪɴ ᴍʏ ʜᴇᴀʀᴛ?", "ᴀᴍɪ ʜᴏɪᴛᴏ ᴄᴀʟᴇɴᴅᴇʀ ɴᴏɪ, ʙᴜᴛ ᴛᴜᴍɪ ᴀᴍᴀʀ ᴇᴠᴇʀʏ ᴅᴀʏ 😘", "What's up?", "Bolo jaan ki korte panmr jonno"];
